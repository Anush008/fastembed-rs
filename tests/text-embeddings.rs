...
fn verify_embeddings(model: &EmbeddingModel, embeddings: &[Embedding]) -> Result<(), Vec<usize>> {
    let expected = match model {
        ...
        EmbeddingModel::MultilingualE5BaseQ => [-0.029701568, -0.1255512, -0.08136139, -0.16696075],
        ...
        EmbeddingModel::MultilingualE5SmallQ => [-0.27530077, -0.15529412, -0.075122215, -0.120935276],
        ...
        EmbeddingModel::EmbeddingGemma300MQ => [0.117917545, 0.3499326, -0.018154081, 1.4971507],
