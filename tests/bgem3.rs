...
fn test_bgem3_joint_embeddings_match_python() {
    ...
    let expected_dense_0 = [-0.018156249076128006, -0.017044715583324432, 0.000982290250249207, 0.0583689846098423, -0.01868816465139389];
    let expected_dense_1 = [-0.011247089132666588, 0.031949788331985474, -0.02800164744257927, -0.009801163338124752, -0.014338407665491104];
    ...
    let expected_colbert_0_tok1 = [-0.02416383847594261, -0.0405534990131855, -0.0560004822909832];
    let expected_colbert_0_tok2 = [-0.01845022290945053, -0.042646653950214386, -0.033078353852033615];
    let expected_colbert_1_tok1 = [-0.013565482571721077, -0.04746083542704582, -0.027890587225556374];
    let expected_colbert_1_tok2 = [0.004542498383671045, -0.05220562964677811, -0.045384544879198074];
