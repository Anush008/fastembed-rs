...
- [**nvidia/llama-nemotron-rerank-1b-v2**](https://huggingface.co/nvidia/llama-nemotron-rerank-1b-v2) — 1B, multilingual, LLaMA-3.2 bidirectional; FP32 (`LlamaNemotronRerank1BV2`) / INT8 (`LlamaNemotronRerank1BV2Int8`) / INT4 (`LlamaNemotronRerank1BV2Int4`) / INT4+INT8-emb 832 MB (`LlamaNemotronRerank1BV2Int4Full`)
